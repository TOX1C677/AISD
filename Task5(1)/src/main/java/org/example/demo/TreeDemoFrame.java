...
import org.example.bst.SimpleBSTree;
import org.example.bst.SimpleBSTreeMap;
import org.example.bst.avl.AVLTreeMap;
import org.example.bst.rb.RBTreeMap;
import org.example.tree.BinaryTreePainter;
import org.example.tree.BinaryTree;
import org.example.bst.BSTree;
import org.example.tree.BinaryTreeAlgorithms;
import org.example.tree.SimpleBinaryTree;
...
//                makeBSTFromValues(new RBTree<>());
        ...
        buttonPreOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                class InnerVisitor implements tree.BinaryTreeAlgorithms.Visitor<Integer> {
                    @Override
                    public void visit(Integer value, int level) {
                        System.out.println(value + " (уровень " + level + ")");
                    }
                }
                tree.BinaryTreeAlgorithms.preOrderVisit(tree.getRoot(), new InnerVisitor());
                */
                System.out.println();
